    ...
    play(){
                ...
                Player.getPlayerInfo();
                 ...
                 for(var plr in allPlayers){
                     ...
                     textSize(25)
                     fill("pink")
                     text("Player 1 score : "+P1score,70,100)
                     text("Player 2 score : "+P2score,70,130)
                ...
                if (keyIsDown(LEFT_ARROW) && player.index !== null) {
                 ...
                 if (frameCount % 20 === 0) {
                  ...
                  if (player.index !== null) {
                     ...
                     // add the condition to calculate the score. and use update the values in the database.
